...
public class Pong extends Canvas implements KeyListener, Runnable
{
	...
	public Pong()
	{
		...
		leftPaddle = new Paddle( 25, 275, 20, 80,
				Color.RED);
		rightPaddle = new Paddle(rightWall.getX() - leftPaddle.getWidth() - 5, 275, 20,
				80, Color.BLUE);
	...
	public void paint(Graphics window)
	{
		...
		graphToBack.drawString("Score Left: " + leftScore, 25,50);
		graphToBack.drawString("Score Right: " + rightScore, 660,50);
